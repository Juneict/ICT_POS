                                ...
                                <table class="table table-bordered table-left">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="btn-group">
                                                        <a href="" data-toggle="modal" data-target="#editUser{{$user->id}}" class="btn btn-sm btn-info"><i class="fa fa-edit"></i> Edit</a>
                                                        <a href="" data-toggle="modal" data-target="#deleteUser{{$user->id}}" class="btn btn-sm btn-danger"><i class="fa fa-trash"></i> Del</a>
                                                    </div>
                                                </td>
                                            </tr>
